...
- **Escape literal `|` in table cells** -- write any `|` inside a cell as `\|` (see the IMPORTANT note above); unescaped pipes corrupt the `Reviewer`, `Confidence`, and `Route` columns
